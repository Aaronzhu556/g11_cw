...
//            logger.info("========"+e.toString()+"==========");
    ...
    public MyResponse getAllRequestService(@RequestBody QueryInfo queryInfo){
        try{
            ...
            else return MyResponse.builder().code("201").msg("没有评论").info(null).build();
        }catch (Exception e){
//            logger.info("=====系统出错"+e.toString());
    ...
    @ResponseBody
    public MyResponse updateServiceProviderStatus(@RequestParam String sestatus, @RequestParam int reid){
